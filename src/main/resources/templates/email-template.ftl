...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"
	...
	max-width: 600px;" class="wrapper">
			...
			color: #FFFFFF;" class="preheader">
                        ...
                        <a target="_blank" style="text-decoration: none;" href="">
                            <img src="https://raw.githubusercontent.com/MuzammalHussain6313/Food-Distribution-App/master/assets/logo4-removebg-preview.png"
			...
			font-family: sans-serif;" class="header">
                        Welcome to Food Distribution Application
                    </td>
                </tr>
	...
	max-width: 600px;" class="wrapper">
                        ...
                        <table
                            ...
                            <tr>
                                ...
                                <td align="center" valign="middle"
                                    ...
                                    <a target="_blank"
                                       href="https://web.facebook.com/groups/3569237649817462/"
			...
			font-family: sans-serif;" class="footer">
                        ...
                        This email was sent to&nbsp;you becouse we&nbsp;want to&nbsp;make the&nbsp;world a&nbsp;better
                        place.<br/> You&nbsp;could change your <a href=""
                                                                  target="_blank"
